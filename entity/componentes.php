<?php 
 ...
 private $caracteristicas_pc_idcaracteristicas_pc ; 
 ...
 if (!is_null($data)) { 
				            ...
				            $this->idComponentes = $data['idComponentes']; 
...
$this->caracteristicas_pc_idcaracteristicas_pc = $data['caracteristicas_pc_idcaracteristicas_pc']; 
 

				        }

    }
public function setidComponentes($idComponentes){ 
...
public function setcaracteristicas_pc_idcaracteristicas_pc($caracteristicas_pc_idcaracteristicas_pc){ 
 $this->caracteristicas_pc_idcaracteristicas_pc = $caracteristicas_pc_idcaracteristicas_pc; 
 return $this; 
}
public function getidComponentes(){ 
...
public function getcaracteristicas_pc_idcaracteristicas_pc(){ 
 return $this->caracteristicas_pc_idcaracteristicas_pc; 
}
}