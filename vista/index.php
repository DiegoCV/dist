    ...
    <body>
        ...
        <div class="wrapper-page">
               ...
               <div align=center >
                     ...
                     <h1 class="logo-name"><img src=<?php Way::ruta('assets/images/logo.png')?> </h1>
                </div>
            <div class="panel panel-color panel-primary panel-pages">
                ...
                <div class="panel-body">
                    <form action="/dist/usuario/validar" class="form-horizontal m-t-20" role="form"  method="post">                      
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input id="Contraseña" name="Contraseña" class="form-control input-lg" type="password" required="" placeholder="Password">
                        </div>
                    </div>
...
<!--                        <div class="col-sm-5 text-right">
        ...
        <script src=<?php Way::ruta('assets/js/jquery.slimscroll.js')?>></script>
        ...
        <script src=<?php Way::ruta('assets/js/jquery.app.js')?>></script>
        
        <script type="text/javascript" src=<?php Way::ruta('assets/js/index.js')?>></script>
